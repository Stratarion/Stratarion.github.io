                ...
                <div class="credit-calc-inputs">
                    <div class="flex">
                        <div class="credit-calc-sum">
                            ...
                            <input type="number" id="creditCalcSum" data-index="1" value="300000" min="200000" max="10000000" onChange="if(this.value<200000){this.value='200000';}" onKeyUp="if(this.value>10000000){this.value='10000000';}">
...
<div class="popup-wrapper">
    <div class="popup popup-credit">
        ...
        <div class="popup-form">
            ...
            <div class="credit-form-agree">
                <input type="checkbox" id="creditPopupFormAgree" checked>
